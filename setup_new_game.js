function starting_menu(){
  ...
  button_1.mouseClicked(function(){start_new_game=true; loop(); button_2.remove(); button_1.remove();});

  button_2 = createButton("OPTIONS");
  button_2.size(120, 25);
  button_2.position(windowWidth/2 - 60, windowHeight/2 + 90);
  button_2.mouseClicked(function(){start_option=true; loop(); button_1.remove(); button_2.remove();})
  pop()
}
